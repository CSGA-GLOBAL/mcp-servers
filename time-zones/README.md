# @csgaglobal/time-zones

Time zone management with conversion, scheduling across zones, and meeting time optimization.
...
```bash
npm install @csgaglobal/time-zones
```

## Quick Start

```typescript
import { createServer } from "@csgaglobal/time-zones";
