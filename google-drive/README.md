# @csgaglobal/google-drive

Google Drive integration for file management, search, sharing, and collaborative document workflows.

**Category:** Cloud Storage | **Version:** 1.0.0 | **License:** MIT
...
```bash
npm install @csgaglobal/google-drive
```

## Quick Start

```typescript
import { createServer } from "@csgaglobal/google-drive";
