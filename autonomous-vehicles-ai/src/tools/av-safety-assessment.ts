...
export function handleAvSafetyAssessment(
  systemName: string,
  autonomyLevel: string,
  aiComponents: string,
  safetyValidation: string,
  jurisdiction: string
): handleAvSafetyAssessmentResult {
  const jurLower = jurisdiction.toLowerCase();
  const fnLower = autonomyLevel.toLowerCase();
