# @csgaglobal/linear-issues

Linear issue tracker integration for project management, sprint planning, and development workflow automation.

**Category:** Project Management | **Version:** 1.0.0 | **License:** MIT
...
```bash
npm install @csgaglobal/linear-issues
```

## Quick Start

```typescript
import { createServer } from "@csgaglobal/linear-issues";
